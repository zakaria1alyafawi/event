...
curl -X POST http://localhost:6000/api/v1/add_tenant \\
  -H \"Content-Type: application/json\" \\
...
```bash
TOKEN="eyJ..."  # from login
curl -X POST http://localhost:6000/api/v1/add_user \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/retrieve_users \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/get_user \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/update_user \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/delete_user \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"id": "uuid"}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/retrieve_events \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"page":1, "limit":10}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/add_events \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/update_events \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/delete_events \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"id": "uuid"}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/retrieve_zones \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/add_zone \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/update_zone \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/delete_zone \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"id": "uuid"}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/get_companies_by_zone \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/retrieve_companies \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/add_company \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/update_company \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/delete_company \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"id": "uuid"}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/qr \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/get_user_by_access_token \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"access_token": "uuid"}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/retrieve_connections \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
  -d '{"page":1}'
```
...
```bash
TOKEN="eyJ..."  
curl -X POST http://localhost:6000/api/v1/add_connection \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $TOKEN" \\
